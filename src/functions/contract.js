...
//       ------------------ CONTRACT UPDATE ------------------
  ...
  export const updateContractSav = async (slug, energie,qualificationsSav, authtoken) =>
  await axios.put(`${API_BASE_URL}/contract/update/sav/${slug}/${energie}`, qualificationsSav, {
    headers: {
      authtoken,
    },
  });
export const updateContractWc = async (slug, energie, qualificationsWc, authtoken) =>
  await axios.put(`${API_BASE_URL}/contract/update/wc/${slug}/${energie}`, qualificationsWc, {
    headers: {
      authtoken,
    },
  });

  export const updateContractQte = async (slug, energie,qualificationsQté, authtoken) =>
  await axios.put(`${API_BASE_URL}/contract/update/quality/${slug}/${energie}`, qualificationsQté, {
    headers: {
      authtoken,
    },
  });
